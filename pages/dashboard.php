...
<div class="wrap">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <a href="https://cloud.shieldfy.io/" class="btn btn-block btn-lg btn-success" target="_blank"><i class="fa fa-dashboard"></i> Open the dashboard on https://shieldfy.io</a>
        </div>
    </div>
</div>